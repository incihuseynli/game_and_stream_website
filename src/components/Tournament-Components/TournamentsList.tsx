    ...
    >
      ...
      <div className={`${styles.flexCenter} flex-col gap-10 w-full`}>
        ...
        >
          <img
            src="./t1.png"
            className="h-24 object-cover md:border-r-2 md:border-r-gray-500 md:border-opacity-20 md:pr-12"
            alt=""
          />
          ...
          <NavLink to="/" className="text-gray-400 text-sm tracking-wide rounded-md uppercase font-bold bg-black-500 py-4 px-6 flex items-center gap-2 mx-auto lg:mx-0  hover:text-secondary-yellow-500 transition-all duration-700 hover:shadow-2xl">
