                ...
                <div className={`${styles.flexCenter} flex-col  gap-6`}>
                  ...
                  <div className="w-full md:w-3/4 flex flex-col items-center gap-4">
                    <p className="text-gray-500 font-poppins tracking-wider text-sm md:text-base">
                      ...
                      aspernatur vitae nemo illum, ratione alias aliquam ullam
                      quod quibusdam mollitia? Lorem ipsum dolor sit amet
                      consectetur adipisicing elit. Alias, dignissimos
                      obcaecati? Consequatur tempora officiis aspernatur vitae
                      nemo illum, ratione alias aliquam ullam quod quibusdam
                      mollitia? Lorem ipsum dolor sit amet consectetur
                      adipisicing elit. Alias, dignissimos obcaecati?
                      Consequatur tempora officiis aspernatur vitae nemo illum,
                      ratione alias aliquam ullam quod quibusdam mollitia? Lorem
                      ipsum dolor sit amet consectetur adipisicing elit. Alias,
                      dignissimos obcaecati? Consequatur tempora officiis
                      aspernatur vitae nemo illum, ratione alias aliquam ullam
                      quod quibusdam mollitia? Lorem ipsum dolor sit amet
                      consectetur adipisicing elit. Alias, dignissimos
                      obcaecati? Consequatur tempora officiis aspernatur vitae
